...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DPUServiceConfigurationHelmChart) DeepCopyInto(out *DPUServiceConfigurationHelmChart) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DPUServiceConfigurationHelmChart.
func (in *DPUServiceConfigurationHelmChart) DeepCopy() *DPUServiceConfigurationHelmChart {
	if in == nil {
		return nil
	}
	out := new(DPUServiceConfigurationHelmChart)
	in.DeepCopyInto(out)
	return out
}
