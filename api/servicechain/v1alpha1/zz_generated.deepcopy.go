...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IPV4CIDR) DeepCopyInto(out *IPV4CIDR) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IPV4CIDR.
func (in *IPV4CIDR) DeepCopy() *IPV4CIDR {
	if in == nil {
		return nil
	}
	out := new(IPV4CIDR)
