...
var _ dpuDuplicateReconciler = &DPUServiceChainReconciler{}
...
func (r *DPUServiceChainReconciler) Reconcile(ctx context.Context, req ctrl.Request) (_ ctrl.Result, reterr error) {
	...
	if !dpuServiceChain.ObjectMeta.DeletionTimestamp.IsZero() {
		...
		err := reconcileDelete(ctx, r.Client, scs, dpuServiceChain, sfcv1.DPUServiceChainFinalizer)
		return ctrl.Result{}, err
	}
	...
	return reconcile(ctx, r.Client, dpuServiceChain, r)
}

func (r *DPUServiceChainReconciler) createOrUpdateChild(ctx context.Context, k8sClient client.Client, dpuObject client.Object) error {
