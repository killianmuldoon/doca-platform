...
import (
	...
	gutil "gitlab-master.nvidia.com/doca-platform-foundation/dpf-operator/internal/provisioning/controllers/util"
...
func (st *dpuRebootingState) Handle(ctx context.Context, client client.Client, _ dutil.DPUOptions) (provisioningdpfv1alpha1.DpuStatus, error) {
	...
	if duration > uptime {
		state.Phase = provisioningdpfv1alpha1.DPUHostNetworkConfiguration
