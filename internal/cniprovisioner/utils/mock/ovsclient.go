...
//
//	mockgen -copyright_file ../../../../hack/boilerplate.go.txt -package utils -destination ../mock/ovsclient.go -source ovs.go
//
...
import (
	...
	types "gitlab-master.nvidia.com/doca-platform-foundation/dpf-operator/internal/cniprovisioner/utils/types"
...
func (m *MockOVSClient) SetBridgeDataPathType(bridge string, bridgeType types.BridgeDataPathType) error {
	m.ctrl.T.Helper()
...
func (m *MockOVSClient) SetPortType(port string, portType types.PortType) error {
	m.ctrl.T.Helper()
