...
import (
	...
	vpccontrollers "github.com/nvidia/doca-platform/internal/vpc/ovn/controllers"
...
func main() {
	...
	if err = (&vpccontrollers.DPUVPCReconciler{
	...
	if err = (&vpccontrollers.ServiceInterfaceReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(ctx, mgr); err != nil {
	...
	if err = (&vpccontrollers.DPUNodeReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(ctx, mgr); err != nil {
