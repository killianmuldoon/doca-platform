...
import (
	...
	sfcsetcontroller "gitlab-master.nvidia.com/doca-platform-foundation/dpf-operator/internal/sfcset/controllers"
...
func main() {
	...
	if err = (&sfcsetcontroller.ServiceInterfaceReconciler{
	...
	if err = (&sfcsetcontroller.ServiceChainReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
